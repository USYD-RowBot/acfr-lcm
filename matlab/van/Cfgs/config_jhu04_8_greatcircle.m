...
TheConfig.Data.navDir = '/files1/data/jhu04/20040228/jhu04-8_greatcircle/';
TheConfig.Data.navFile = 'nav_t.mat';
TheConfig.Data.navLoader = [];

% image directory
TheConfig.Data.imageDir  = '/files1/data/jhu04/20040226/jhu04-8_greatcircle/images_pxf/';
...
TheConfig.Data.imageSequence = [25:1:1746]'+1;
...
TheConfig.Data.outdir = '/files1/processed/van/output/jhu04-8_greatcircle/';
...
TheConfig.ekf.use_rdi   = 2; % 0 - off
                            ...
                            % 2 - u,v,w
			    % 3 - u,v,w,r,p
TheConfig.ekf.use_xbow  = 1; % 0 - off
                            % 1 - rdot,pdot,hdot
