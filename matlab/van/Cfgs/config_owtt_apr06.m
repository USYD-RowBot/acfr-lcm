%JULY 2005  Chios05-03 dataset using SeaBED w/ color camera
...
TheConfig.Data.navDir = '/files1/data/owtt-2006.04/d20060408/owtt_harbor/bottomside';
TheConfig.Data.navFile = '20060408_1858.SEABED.syscfg';
TheConfig.Data.navLoader = @loadseabed;
TheConfig.Data.navLoaderArgs = {TheConfig.Data.navDir, ...
		                TheConfig.Data.navFile, ...
		               -12345, ... % pre 12/2005 = -98765, post 12/2005 = -12345
		                false};    % true if world-frame, false if sensor-frame

% image directory
TheConfig.Data.imageDir  = [];

% image extentions [e.g. tif jpg png etc]
TheConfig.Data.imageExtension = [];

% camera calibration file & image size
TheConfig.Data.imageCalibrationFile = [];
...
TheConfig.Data.outdir = '/home/ryan/van_processed/owtt2006-04/';
...
% DOPPLER TO VEHICLE
%--------------------------------------
TheConfig.SensorXform.RDI.Rvs = rotxyz([180,0,90]*DTOR); % default
...
% PHINS TO VEHICLE
%--------------------------------------
TheConfig.SensorXform.PHINS.Rvs = rotxyz([180,0,0]*DTOR); % rme
TheConfig.SensorXform.PHINS.tvs_v = [0, 0, -1.15]';
...
TheConfig.SensorXform.PARO.tvs_v = [0, -0.12, 0]';
