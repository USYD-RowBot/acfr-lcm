...
TheConfig.Data.navFile = '20050707_1733.SEABED.syscfg';
...
% image directory
TheConfig.Data.imageDir  = '/files1/data/chios05/Images/chios05-03_dense_grid/ColorProcessed/';
...
iseq = load('/files1/data/chios05/Images/chios05-03_dense_grid/chios05-03.good.seq');
iseq = iseq((iseq >= 660) & (iseq <= 740));
%iseq = iseq((iseq >= 629) & (iseq <= 1364));
%iseq = [2554:2557];
%TheConfig.Data.imageSequence = [784:875];
...
TheConfig.Data.outdir = '/home/ryan/van_processed/chios05-03/';
