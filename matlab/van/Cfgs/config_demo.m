...
%======================================
% rootdir
%TheConfig.Data.rootdir = '/home/ryan/4stefan/van-20061030/';

% sysconfig file (full pathname)
TheConfig.Data.navDir = '../data/jhu04-sample/';
TheConfig.Data.navFile = 'nav_t.mat';
TheConfig.Data.navLoader = @loadjhu;
TheConfig.Data.navLoaderArgs = {TheConfig.Data.navDir,TheConfig.Data.navFile};

% image directory
TheConfig.Data.imageDir  = '../data/jhu04-sample/Images/';

% image extentions [e.g. tif jpg png etc]
TheConfig.Data.imageExtension = 'png';

% camera calibration file
TheConfig.Data.imageCalibrationFile = '../data/jhu04-sample/calib_jhu20040226_bw.m';
