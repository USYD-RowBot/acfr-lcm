function x0 = multigrid(A0,b0,x0,Nv,Xp_i,C,S);
%function x0 = multigrid(A0,b0,x0,Nv,C);  

% do c v-cycle's
for c=1:C
  x0 = vcycle(0,A0,b0,x0,Nv,Xp_i,S);
end


%===============================================================
function eh_out = vcycle(level,Ah,bh,xh,Nv,Xp_i,S);
COARSEST_LEVEL =  length(xh)/Nv < 33;
