function [link_t,fni,fnj] = linkhypoth_eifC(link_t,TheJournal,TheConfig)
% INPUT:
...
for ii=Ni:Nf
  ...
  for jj=ii+1:Nf
    ...
    xij_i = [Xf_i_full,Xf_j_full];
    m_plus = markov_blanket(TheJournal.Eif.Lambda,xij_i);
    ind = [xij_i, m_plus];
    Sigma = TheJournal.Eif.Lambda(ind,ind)^-1;
