function [link_t,fni,fnj] = linkhypoth_ekfA(link_t,TheJournal,TheConfig)
% INPUT:
...
for ii=Ni:Nf
  ...
  Xf_i = TheJournal.Index.Xf_ii{ii}(TheJournal.Index.Xp_i);
  ...
  for jj=ii+1:Nf
    ...
    Xf_j = TheJournal.Index.Xf_ii{jj}(TheJournal.Index.Xp_i);
