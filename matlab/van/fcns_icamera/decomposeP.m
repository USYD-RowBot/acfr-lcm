...
% decomposeP   Camera matrix decomposition.
%    [K,R,C] = decomposeP(P) decomposes the [3x4] camera matrix P into a
%    [3x3] upper triangular matrix K, a [3x3] unitary matrix R, and
%    a [3x1] inhomogenous vector C.  
%
...
%    3D world, (i.e. y-axis increases in the upwards direction
%    in the image plane).
%
%    History:
%    Date            Who         What
...
%    07-10-2003      rme         Renamed function from krc to decomposeP
%                                and changed the output C to be a [3x1] 
%                                inhomogenous vector.
...
if rank(M) == 3
  ...
  error('P is not a finite camera, M is singular!');
end
