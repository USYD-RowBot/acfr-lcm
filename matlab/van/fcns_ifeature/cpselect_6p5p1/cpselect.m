...
%
%   ******************* NOTE *******************************
%   01/07/2004  rme   Modified to accept color RGB images.  

%   Copyright 1993-2003 The MathWorks, Inc.
%   $Revision: 1.33 $  $Date: 2003/03/10 19:19:47 $
...
if isempty(javachk('swing')) && strncmpi('Java 1.3.1', version('-java'), 10)
  java_available = true;
end
