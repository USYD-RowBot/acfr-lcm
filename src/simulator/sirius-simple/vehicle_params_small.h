...
SMALL::Matrix66 inv_inertia;

void populate_inv_inertia()
{
    inv_inertia[0][0] = 3.276891e-02;
    inv_inertia[0][1] = 0;
    inv_inertia[0][2] = -2.974202e-04;
    inv_inertia[0][3] = 0;
    inv_inertia[0][4] = -1.036562e-03;
    inv_inertia[0][5] = 0;
    inv_inertia[1][0] = 0;
    inv_inertia[1][1] = 1.318658e-02;
    inv_inertia[1][2] = 0;
    inv_inertia[1][3] = 4.517519e-02;
    inv_inertia[1][4] = 0;
    inv_inertia[1][5] = -6.460883e-03;
    inv_inertia[2][0] = -2.974202e-04;
    inv_inertia[2][1] = 0;
    inv_inertia[2][2] = 1.235243e-02;
    inv_inertia[2][3] = 0;
    inv_inertia[2][4] = 6.060268e-03;
    inv_inertia[2][5] = 0;
    inv_inertia[3][0] = 0;
    inv_inertia[3][1] = 4.517519e-02;
    inv_inertia[3][2] = 0;
    inv_inertia[3][3] = 2.438660e+00;
    inv_inertia[3][4] = 0;
    inv_inertia[3][5] = -2.213399e-02;
    inv_inertia[4][0] = -1.036562e-03;
    inv_inertia[4][1] = 0;
    inv_inertia[4][2] = 6.060268e-03;
    inv_inertia[4][3] = 0;
    inv_inertia[4][4] = 2.112111e-02;
    inv_inertia[4][5] = 0;
    inv_inertia[5][0] = 0;
    inv_inertia[5][1] = -6.460883e-03;
    inv_inertia[5][2] = 0;
    inv_inertia[5][3] = -2.213399e-02;
    inv_inertia[5][4] = 0;
    inv_inertia[5][5] = 2.128922e-02;
}
