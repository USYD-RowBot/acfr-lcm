...
void VehicleSimBase::updateState( const state_type &x , state_type &dxdt , const double /* t */ )
{
    double Xa, Ya, Za;
    double u, v, w, p, q, r;
...
void VehicleSimBase::on_motor_command(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const auv_nga_motor_command_t *mc, lcm::LCM *lcm) 
{
    in = *mc;
}
...
void VehicleSimBase::on_nav_store(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const auv_acfr_nav_t *nav, lcm::LCM *lcm) 
{
    cout << "Nav: ";
