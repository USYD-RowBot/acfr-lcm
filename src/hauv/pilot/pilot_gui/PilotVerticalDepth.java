...
public class PilotVerticalDepth implements Runnable {
    ...
    public void run() {
        ...
        */
        ...
        for (int irow = 0; irow < npoints; irow++){
            ...
            wayptsGlobal[irow][0] = -plan.waypoints[irow][0] + depth; //plan.waypoints[irow][0] + x_dvl; previously
        ...
        while (flag == 1) {	 //alternatively, try "reset==1"
            ...
            while (nextWaypt == 0 && flag == 1) {
                ...
                */
				...
				System.out.println("x_dvl: "+x_dvl+" ywaypt: "+ywaypt+" y_dvl: "+y_dvl+" y_hold: "+y_hold+" depth: "+depth+" xwaypt: "+xwaypt);				
    ...
    public static void main(String args[]) {
        ...
        while (true) {
			...
			if (broadcast == true) {
				...
				flag = 1;	
				PilotVerticalDepth p = new PilotVerticalDepth();
				t = new Thread(p);
				t.start();
