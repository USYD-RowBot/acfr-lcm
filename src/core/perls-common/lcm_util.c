...
lcmu_channel_get_os_conduit (BotParam *param, lcmu_channel_os_conduit_t type)
{
    ...
    case LCMU_CHANNEL_OS_CONDUIT_OSI:
        ...
        break;
    case LCMU_CHANNEL_OS_CONDUIT_RPHTD:
        channel = lcmu_channel_get_prepost (NULL, basechannel, "_RPHDT");
        break;

    case LCMU_CHANNEL_OS_CONDUIT_OMLOAD:
        channel = lcmu_channel_get_prepost (NULL, basechannel, "_OMLOAD");
        break;
