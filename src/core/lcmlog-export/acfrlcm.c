                             ...
                             const acfrlcm_auv_global_planner_t *msg, void *user)
{
    ...
    TEXTREAD_ADD_FIELD (tr, "point(:,1)",    "%f", msg->point[0]);
    TEXTREAD_ADD_FIELD (tr, "point(:,2)",    "%f", msg->point[1]);
    TEXTREAD_ADD_FIELD (tr, "point(:,3)",    "%f", msg->point[2]);
    TEXTREAD_ADD_FIELD (tr, "point(:,4)",    "%f", msg->point[3]);
    TEXTREAD_ADD_FIELD (tr, "point(:,5)",    "%f", msg->point[4]);
    TEXTREAD_ADD_FIELD (tr, "point(:,6)",    "%f", msg->point[5]);
