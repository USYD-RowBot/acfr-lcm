...
main(int argc, char *argv[])
{
    ...
    if (f == NULL)
    {
        printf("Failed to open result_ekf.txt\n");
    }
    ...
    if (f == NULL)
    {
        printf("Failed to open result_cov_ekf.txt\n");
    }
    ...
    if (f == NULL)
    {
        printf("Failed to open result_ukf.txt\n");
    }
    ...
    if (f == NULL)
    {
        printf("Failed to open result_cov_ukf.txt\n");
    }
    ...
    if (f == NULL)
    {
        printf("Failed to open result_pf.txt\n");
    }
    ...
    if (f == NULL)
    {
        printf("Failed to open result_cov_pf.txt\n");
    }
    ...
    // clean up ----------------------------------------------------------------
    if(bearing_meas.user != NULL)
    {
        free(bearing_meas.user);
    }
    if(bearing_meas.z != NULL)
    {
        gsl_vector_free(bearing_meas.z);
    }
    if(bearing_meas.R != NULL)
    {
        gsl_matrix_free(bearing_meas.R);
    }
    if(pred.user != NULL)
    {
        free(pred.user);
    ...
    if(pred.u != NULL)
    {
        gsl_vector_free(pred.u);
    }
    if(pred.Q != NULL)
    {
        gsl_matrix_free(pred.Q);
    }
