...
int main(int argc, char *argv[])
{
    ...
    gsl_vector_fscanf (fk, K_and_opt);  fclose (fk);
    FILE * fx21 = fopen ("../share/examples/_test_ba_files/ba_x21.txt", "rb");  gsl_vector_fscanf (fx21, X_c2c1);  fclose (fx21);
    FILE * fx_5dof = fopen ("../share/examples/_test_ba_files/x_5dof.txt", "rb");  gsl_vector_fscanf (fx_5dof, x_5dof);  fclose (fx_5dof);
    ...
    if (bundle_E) {
        ...
        FILE * fuv1 = fopen ("../share/examples/_test_ba_files/ba_uv1.txt", "rb");  gsl_matrix_fscanf (fuv1, uv1_f);  fclose(fuv1);
        FILE * fuv2 = fopen ("../share/examples/_test_ba_files/ba_uv2.txt", "rb");  gsl_matrix_fscanf (fuv2, uv2_f);  fclose(fuv2);
        FILE * fX1 = fopen ("../share/examples/_test_ba_files/ba_X1.txt", "rb");  gsl_matrix_fscanf (fX1, X1);  fclose(fX1);
        ...
        FILE * fuv1 = fopen ("../share/examples/_test_ba_files/ba_uv1.txt", "rb");  gsl_matrix_fscanf (fuv1, uv1_h);  fclose(fuv1);
        FILE * fuv2 = fopen ("../share/examples/_test_ba_files/ba_uv2.txt", "rb");  gsl_matrix_fscanf (fuv2, uv2_h);  fclose(fuv2);
        FILE * fuv1p = fopen ("../share/examples/_test_ba_files/ba_uv1p.txt", "rb"); gsl_matrix_fscanf (fuv1p, uv1_proj); fclose(fuv1p);
    ...
    if (ret!=VIS_SBA_ERROR && ret_robust!=VIS_SBA_ERROR) {
        ...
        FILE *fx21_ans = fopen ("../share/examples/_test_ba_files/ans_x21.txt", "rb");  gsl_vector_fscanf (fx21_ans, ans_x21);  fclose(fx21_ans);
        FILE *fS21_ans = fopen ("../share/examples/_test_ba_files/ans_S21.txt", "rb");  gsl_matrix_fscanf (fS21_ans, ans_S21);  fclose(fS21_ans);
        //gsl_vector_scale(p12,RTOD);
        ...
        FILE *fx21_ans_robust = fopen ("../share/examples/_test_ba_files/ans_x21_robust.txt", "rb");  gsl_vector_fscanf (fx21_ans_robust, ans_x21_robust);  fclose(fx21_ans_robust);
        FILE *fS21_ans_robust = fopen ("../share/examples/_test_ba_files/ans_S21_robust.txt", "rb");  gsl_matrix_fscanf (fS21_ans_robust, ans_S21_robust);  fclose(fS21_ans_robust);
        //gsl_vector_scale(p12,RTOD);
