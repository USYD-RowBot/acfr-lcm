                                                  ...
                                                  int generated_image_height)
{
  ...
  if (generated_image != 0){ cvReleaseImage(&generated_image); }
  if (generated_image_width < 0){ generated_image = cvCloneImage(p_original_image); }
  else{ generated_image = cvCreateImage(cvSize(generated_image_width, generated_image_height), IPL_DEPTH_8U, 1); }
...
void affine_image_generator06::generate_affine_image(void)
{
  ...
  if (use_random_background){ replace_by_noise(generated_image, 128); }
