...
typedef enum _applanix_data_type applanix_data_type_t;
enum _applanix_data_type {
    APPLANIX_DATA_GRP,
    APPLANIX_DATA_MSG,
};
...
int
applanix_decode_grp2 (applanix_grp2_t *grp, const uint8_t *data);

int
applanix_decode_grp3 (applanix_grp3_t *grp, const uint8_t *data);
...
int
applanix_encode_msg22 (const applanix_msg22_t *msg, uint8_t *data,
                       int length);
...
int
applanix_encode_msg54 (const applanix_msg54_t *msg, uint8_t * data,
                       int length);

int
applanix_encode_msg57 (const applanix_msg57_t *msg, uint8_t * data,
                       int length);
...
#if 0
int
applanix_grp1_to_imu_t(const applanix_grp1_t *grp1, imu_t *imu, uint64_t utime);

int
applanix_grp1_to_nmea_t(const applanix_grp1_t *grp1, nmea_t *nmea, uint64_t utime);
