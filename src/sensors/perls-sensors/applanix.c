...
static char *time_types[] = { "POS", "GPS", "UTC", "User" };
static char *dist_types[] = { "N/A", "POS", "DMI" };
...
applanix_decode_grp10002 (applanix_grp10002_t *grp, const uint8_t *data)
{
    ...
    memcpy (grp->data, data + 42, GSL_MIN (grp->length, 64));
...
applanix_print_grp10002 (FILE *f, const applanix_grp10002_t *grp)
{
    ...
    fprintf (f, " ");
    for (int i = 0; i < GSL_MIN (grp->length, 64); i++)
